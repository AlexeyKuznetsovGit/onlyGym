...
class PjText extends StatelessWidget {
  ...
  FontWeight get fontWeight {
    if (style == PjTextStyle.h1 ||
        style == PjTextStyle.title ||
        style == PjTextStyle.bold) return FontWeight.w700;
    if (style == PjTextStyle.medium || style == PjTextStyle.tiny)
      return FontWeight.w500;
    if (style == PjTextStyle.regular || style == PjTextStyle.downmenu)
